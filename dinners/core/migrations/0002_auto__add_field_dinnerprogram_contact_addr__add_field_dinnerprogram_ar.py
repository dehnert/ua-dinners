...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('core_dinnerprogram', 'contact_addr', self.gf('django.db.models.fields.EmailField')(default='ua-dinners-dev@mit.edu', max_length=75), keep_default=False)

        # Adding field 'DinnerProgram.archive_addr'
        db.add_column('core_dinnerprogram', 'archive_addr', self.gf('django.db.models.fields.EmailField')(default='ua-dinners-dev@mit.edu', max_length=75), keep_default=False)

        # Removing M2M table for field students on 'dinner'
        db.delete_table('core_dinner_students')
    ...
    def backwards(self, orm):
        ...
        # Adding M2M table for field students on 'dinner'
        db.create_table('core_dinner_students', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('dinner', models.ForeignKey(orm['core.dinner'], null=False)),
            ('athenaperson', models.ForeignKey(orm['people.athenaperson'], null=False))
        ))
        db.create_unique('core_dinner_students', ['dinner_id', 'athenaperson_id'])
