...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DinnerParticipant.person'
        db.alter_column('core_dinnerparticipant', 'person_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['people.AthenaPerson'], to_field='krb_name'))


    def backwards(self, orm):
        
        # Changing field 'DinnerParticipant.person'
        db.alter_column('core_dinnerparticipant', 'person_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['people.AthenaPerson']))
