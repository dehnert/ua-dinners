...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('people_athenaperson', 'first_name', self.gf('django.db.models.fields.CharField')(max_length=45, null=True, blank=True))

        # Changing field 'AthenaPerson.last_name'
        db.alter_column('people_athenaperson', 'last_name', self.gf('django.db.models.fields.CharField')(max_length=45))

        # Changing field 'AthenaPerson.office_location'
        db.alter_column('people_athenaperson', 'office_location', self.gf('django.db.models.fields.CharField')(max_length=45, null=True, blank=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'AthenaPerson.last_name'
        db.alter_column('people_athenaperson', 'last_name', self.gf('django.db.models.fields.CharField')(max_length=30))
