...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'AthenaPerson', fields ['krb_name']
        db.create_unique('people_athenaperson', ['krb_name'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'AthenaPerson', fields ['krb_name']
        db.delete_unique('people_athenaperson', ['krb_name'])
